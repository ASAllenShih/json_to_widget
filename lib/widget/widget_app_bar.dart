...
class WidgetAppBar extends WidgetParser {
  ...
  @override
  Widget parse(JsonToWidget jsonToWidget, Map<String, dynamic> data, BuildContext buildContext) {
    return AppBar(
      ...
      actions: methodTypeWidgetList(jsonToWidget, data['actions'], buildContext),
      flexibleSpace: methodTypeWidget(jsonToWidget, data['flexibleSpace'], buildContext),
      bottom: methodTypeWidget(jsonToWidget, data['bottom'], buildContext) as PreferredSizeWidget?,
